...
window.location.href = uUS+'?source='+stc+'#join';
  
} 
  
else if (country_code == "GB"){

window.location.href = uGB+'?source='+stc+'#join';
  
}

else if (country_code == "CA"){

window.location.href = uCA+'?source='+stc+'#join';
  
}

else if (country_code == "FR"){

window.location.href = uFR+'?source='+stc+'#join';
  
}

else if (country_code == "IT"){

window.location.href = uIT+'?source='+stc+'#join';
  
}

else if (country_code == "DE"){

window.location.href = uDE+'?source='+stc+'#join';
  
}

else if (country_code == "AU"){

window.location.href = uAU+'?source='+stc+'#join';
  
}
  
else { 
  
window.location.href = uOUTROS+'?source='+stc+'#join'; 
