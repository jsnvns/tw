...
function Click1(uUS, uGB, uCA, uFR, uIT, uDE, uAU, uOUTROS, stc)     
{
...
window.location.href = uUS+'?source='+stc;
  
} 
  
else if (country_code == "GB"){

window.location.href = uGB+'?source='+stc;
  
}

else if (country_code == "CA"){

window.location.href = uCA+'?source='+stc;
  
}

else if (country_code == "FR"){

window.location.href = uFR+'?source='+stc;
  
}

else if (country_code == "IT"){

window.location.href = uIT+'?source='+stc;
  
}

else if (country_code == "DE"){

window.location.href = uDE+'?source='+stc;
  
}

else if (country_code == "AU"){

window.location.href = uAU+'?source='+stc;
  
}
  
else { 
  
window.location.href = uOUTROS+'?source='+stc; 
...
window.location.href = "https://www.smtdate.cf/"+stc; 
